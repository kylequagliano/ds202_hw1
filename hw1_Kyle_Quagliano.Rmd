...
My name is **Kyle Quagliano**, I am a *Computer Science* major       with a Data Science minor. I grew up in Illinois and am now         going into my final year of education. This summer I had an          Internship at the Iowa DoT where I was a programmer. Some            hobbies that I enjoy are baseball, volleyball,                       Rollerblading, and drumming.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
  ...
  A job that I think is related to data science is a Data Architect. A Data Architect is a mix between a Data Engineer and a Data Scientist.They conceptualize and visualize data frameworks and provide guidance when handling data sources from databases.They plan and manage big data databases. 
  [Link To Website](https://onlinedatasciencemasters.virginia.edu/blog/what-is-a-data-architect/#:~:text=The%20data%20architect%20is%20an%20essential%20part%20of,systems%20with%20a%20desired%20future%20state%20in%20mind.)
  ![Image](C:\Users\kquag\Pictures\DataArchitect.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

   I think the topic I will be most interested in will be Data acquisition, but more specifically web-scraping.
